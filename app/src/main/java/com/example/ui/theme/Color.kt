...
val md_theme_light_primary = Color(0xFF4F46E5)     // Vibrant Indigo
...
val md_theme_dark_primary = Color(0xFF9CCAFF)      // Light blue for high-contrast visibility in Dark Mode
val md_theme_dark_onPrimary = Color(0xFF003258)    // Dark blue text over light blue
val md_theme_dark_background = Color(0xFF101417)   // OLED/Very dark slate
val md_theme_dark_onBackground = Color(0xFFE1E2E5) // Soft comfortable light gray
val md_theme_dark_surface = Color(0xFF1C1C1E)      // Sleek dark surface card
val md_theme_dark_onSurface = Color(0xFFE1E2E5)
val md_theme_dark_outline = Color(0xFF8E9194)
val md_theme_dark_onSurfaceVariant = Color(0xFFC4C7CC) // Secondary light gray text
...
val AccentGreen = Color(0xFF06B6D4)      // Electric Cyan
...
val SuccessGreen = Color(0xFF10B981)     // Emerald-550
val WarningOrange = Color(0xFFF59E0B)    // Amber-500
val DangerRed = Color(0xFFEF4444)        // Ruby Rose
